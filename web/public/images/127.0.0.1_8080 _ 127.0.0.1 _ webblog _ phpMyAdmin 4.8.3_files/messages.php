...
PMA_messages['strNoAccountSelected'] = "Не выбрано учетных записей.";
...
PMA_messages['strAddTables'] = "Добавить таблицы из других баз данных";
...
PMA_messages['phpErrorsFound'] = "<div class=\"error\">На сервере обнаружены некоторые ошибки!<br/>Пожалуйста, посмотрите вниз текущего окна.<div><input id=\"pma_ignore_errors_popup\" type=\"submit\" value=\"Игнорировать\" class=\"floatright message_errors_found\"><input id=\"pma_ignore_all_errors_popup\" type=\"submit\" value=\"Игнорировать всё\" class=\"floatright message_errors_found\"></div></div>";
...
PMA_messages['strU2FTimeout'] = "Превышено время ожидания для активации ключа безопасности.";
PMA_messages['strU2FError'] = "Ошибка активации ключа безопасности (%s).";
